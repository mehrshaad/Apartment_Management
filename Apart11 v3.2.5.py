# Apartment 11 Management v3.2.5
# Copyright (c) 2020 Mehrshad Dadashzadeh
# https://github.com/mehrshaad/
# https://www.linkedin.com/in/ali-dadashzadeh-7053491b3/
#
...
if P.system() == 'Windows':
    if P.release() == '10' or P.release() == '11':
        win10key = True
    else:
        win10key = False
else:
...
DevText = "Developed by <b>Mehrshad Dadashzadeh</b>"
DevLink = "https://github.com/mehrshaad"
...
Data_2 = {  # texts and shadow data
    "Manabe": {
        b'\u0645\u0648\u062C\u0648\u062F\u06CC \u0646\u0642\u0644 \u0627\u0632 \u062F\u0648\u0631\u0647 \u0642\u0628\u0644'.decode('unicode-escape'):
        2,
        b'\u0633\u0648\u062F \u062D\u0627\u0635\u0644 \u0627\u0632 \u0633\u067E\u0631\u062F\u0647 \u0633\u0631\u0645\u0627\u06CC\u0647 \u06AF\u0630\u0627\u0631\u06CC \u06A9\u0648\u062A\u0627\u0647 \u0645\u062F\u062A'.decode('unicode-escape'):
        3,
        b'\u0645\u0648\u062C\u0648\u062F\u06CC \u062C\u0627\u0631\u06CC'.decode('unicode-escape'):
        4
    },
    "Masaref": {
        b'\u0647\u0632\u06CC\u0646\u0647 \u0633\u0631\u0648\u06CC\u0633 \u0648 \u0646\u06AF\u0647 \u062F\u0627\u0631\u06CC \u0622\u0633\u0627\u0646\u0633\u0648\u0631 \u0648 \u0628\u06CC\u0645\u0647 \u0646\u0627\u0645\u0647'.decode('unicode-escape'):
        6,
        b'\u0647\u0632\u06CC\u0646\u0647 \u0646\u0638\u0627\u0641\u062A \u0639\u0645\u0648\u0645\u06CC \u0633\u0627\u062E\u062A\u0645\u0627\u0646 (\u0633\u0647 \u0646\u0648\u0628\u062A \u0647\u0631 \u0645\u0627\u0647)'.decode('unicode-escape'):
        7,
        b'\u0647\u0632\u06CC\u0646\u0647 \u0639\u06CC\u062F\u06CC \u06A9\u0627\u0631\u06AF\u0631\u0627\u0646 \u0634\u0647\u0631\u062F\u0627\u0631\u06CC'.decode('unicode-escape'):
        8,
        b'\u0647\u0632\u06CC\u0646\u0647 \u0644\u0648\u0627\u0632\u0645 \u0634\u0648\u06CC\u0646\u062F\u0647'.decode('unicode-escape'):
        9,
        b'\u0647\u0632\u06CC\u0646\u0647 \u0628\u0631\u0642 \u0645\u0635\u0631\u0641\u06CC - \u0642\u0628\u0636 \u0639\u0645\u0648\u0645\u06CC'.decode('unicode-escape'):
        10,
        b'\u0647\u0632\u06CC\u0646\u0647 \u0622\u0628 \u0645\u0635\u0631\u0641\u06CC - \u0633\u0647\u0645 \u062E\u0627\u0646\u0648\u0627\u0631'.decode('unicode-escape'):
        11,
        b'\u0647\u0632\u06CC\u0646\u0647 \u062E\u0631\u06CC\u062F \u06AF\u0644 \u0648 \u0628\u0627\u063A\u0628\u0627\u0646\u06CC (\u062D\u06CC\u0627\u0637 \u0648 \u0648\u0631\u0648\u062F\u06CC \u0633\u0627\u062E\u062A\u0645\u0627\u0646)'.decode('unicode-escape'):
        12,
        b'\u0647\u0632\u06CC\u0646\u0647 \u0647\u0627\u06CC \u0645\u0627\u0644\u06CC - \u06A9\u0627\u0631\u0645\u0632\u062F \u0628\u0627\u0646\u06A9\u06CC \u0648 \u0635\u062F\u0648\u0631 \u0635\u0648\u0631\u062A\u062D\u0633\u0627\u0628'.decode('unicode-escape'):
        13,
        b'\u0647\u0632\u06CC\u0646\u0647 \u062A\u0639\u0645\u06CC\u0631\u0627\u062A'.decode('unicode-escape'):
        14,
        b'\u0634\u0627\u0631\u0698 \u0633\u06CC\u0645 \u06A9\u0627\u0631\u062A \u062A\u0644\u0641\u0646 \u0647\u0645\u0631\u0627\u0647 \u0633\u0627\u062E\u062A\u0645\u0627\u0646'.decode('unicode-escape'):
        15,
        b'\u0644\u0648\u0627\u0632\u0645 \u0645\u0635\u0631\u0641\u06CC \u062A\u0627\u0633\u06CC\u0633\u0627\u062A\u06CC'.decode('unicode-escape'):
        16
    },
    "1st6Month": {
        b'\u0641\u0631\u0648\u0631\u062F\u06CC\u0646'.decode('unicode-escape'):
        ['B', '01'],
        b'\u0627\u0631\u062F\u06CC\u0628\u0647\u0634\u062A'.decode('unicode-escape'):
        ['C', '02'],
        b'\u062E\u0631\u062F\u0627\u062F'.decode('unicode-escape'):
        ['D', '03'],
        b'\u062A\u06CC\u0631'.decode('unicode-escape'): ['E', '04'],
        b'\u0645\u0631\u062F\u0627\u062F'.decode('unicode-escape'):
        ['F', '05'],
        b'\u0634\u0647\u0631\u06CC\u0648\u0631'.decode('unicode-escape'):
        ['G', '06']
    },
    "2nd6Month": {
    ...
    "Shadow": {
        'light': {
            ...
            'xOffset': 0,
            'yOffset': 0,
            'color': Qt.QColor(27, 151, 243)
        },
        'dark': {
            'blurRadius': 5,
            'xOffset': 0,
            'yOffset': 0,
            'color': Qt.QColor(237, 255, 153)
        },
        'start': {
            'blurRadius': 20,
            'xOffset': 1,
            'yOffset': 2,
            'color': Qt.QColor(0, 0, 0, 60)
        }
    }
}
Data_3 = {  # empty data for storing in-app runtime data
    ...
    'fileName':
    f"Excel\\1st 6 Month of {Data['ActiveYear']}.xlsx" if Data['Bilan6Month']
    else f"Excel\\2nd 6 Month of {Data['ActiveYear']}.xlsx"
}
...
def saveExcel(mode, data={}):
    ...
    if mode == 'abyari':
        sheet = 'آبیاری'
        vahed = list(
            set([int(i) for i in range(1, 14)]) - set(Data['AbyariFilter']))
        font = E.Font(name='B Nazanin',
                      charset=178,
                      family=None,
                      b=False,
...
def shadowEffect(item,
                 object,
                 mode='',
                 remove=False,
                 Filter=['ButtSettings', 'ButtBack'],
                 onlyFilter=False):
    global Data
    if mode.lower() == 'light' or remove:
        for child in item.findChildren(object):
            ...
            if remove:
                ...
                continue
            shadow = Qt.QGraphicsDropShadowEffect(blurRadius=10,
                                                  xOffset=2,
                                                  yOffset=1,
                                                  color=Qt.QColor('gray'))
        ...
        for child in item.findChildren(object):
            ...
            if remove:
                child.setGraphicsEffect(None)
                continue
            shadow = Qt.QGraphicsDropShadowEffect(blurRadius=20,
                                                  xOffset=0,
                                                  yOffset=0,
                                                  color=Qt.QColor(
                                                      237, 255, 153))
...
class Windows:
    ...
    def checkStyle(self):
        try:
            ...
            pass
        try:
            self.bilan.checkStyle()
        except:
            pass
        try:
            self.sharj.checkStyle()
        except:
            pass
        try:
            self.abyari.checkStyle()
        except:
            pass
        try:
            self.output.checkStyle()
        except:
            pass
        try:
            self.main.checkStyle()
        except:
            pass
...
class Ui_startapp(object):
    ...
    def setupUi(self, startapp):
        ...
        self.centralwidget.setGraphicsEffect(
            Qt.QGraphicsDropShadowEffect(
                blurRadius=Data_2['Shadow']['start']['blurRadius'],
                xOffset=Data_2['Shadow']['start']['xOffset'],
                yOffset=Data_2['Shadow']['start']['yOffset'],
                color=Data_2['Shadow']['start']['color']))
        ...
        self.mehrshad.setAlignment(QtCore.Qt.AlignBottom | QtCore.Qt.AlignRight
    ...
    def retranslateUi(self, startapp):
        ...
        self.title.setText(
            _translate("startapp", "<strong>Apartment 11</strong> Management"))
        self.description.setText(
            _translate("startapp", "An easier way to manage your apartment"))
        self.loading.setText(_translate("startapp", "loading..."))
        self.mehrshad.setText(
            _translate("startapp",
                       "<strong>CREATED BY</strong> Mehrshad Dadashzadeh"))
...
class Ui_main(object):
    ...
    def setupUi(self, main):
        ...
        self.ButtSettings.setCursor(QtGui.QCursor(
            QtCore.Qt.PointingHandCursor))
        self.ButtSettings.setStyleSheet(css.butt_transparent)
        self.ButtSettings.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/pics/.Images/Icon/settings.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, main):
        ...
        self.ButtSettings.setWhatsThis(
            _translate(
                "main",
                "<html><head/><body><p align=\"center\">تنظیمات</p></body></html>"
            ))
        ...
        if not Data['DarkMode']:
            ...
            if Data['ShadowEffect']:
                ...
                self.label.setGraphicsEffect(
                    Qt.QGraphicsDropShadowEffect(
                        blurRadius=Data_2['Shadow']['light']['blurRadius'],
                        xOffset=Data_2['Shadow']['light']['xOffset'],
                        yOffset=Data_2['Shadow']['light']['yOffset'],
                        color=Data_2['Shadow']['light']['color']))
            else:
            ...
            if Data['ShadowEffect']:
                ...
                self.label.setGraphicsEffect(
                    Qt.QGraphicsDropShadowEffect(
                        blurRadius=Data_2['Shadow']['dark']['blurRadius'],
                        xOffset=Data_2['Shadow']['dark']['xOffset'],
                        yOffset=Data_2['Shadow']['dark']['yOffset'],
                        color=Data_2['Shadow']['dark']['color']))
            else:
                shadowEffect(self.name, QtWidgets.QPushButton, remove=True)
                self.label.setGraphicsEffect(None)
...
class Ui_settings(object):
    ...
    def setupUi(self, settings):
        ...
        self.CheckBilan6Month.setCursor(
            QtGui.QCursor(setCurser(not Data_3['donePages']['bilan'])))
        ...
        self.CheckBilan6Month.clicked.connect(self.checkBilan)
        self.CheckChangeBy1000.clicked.connect(self.check1000)
        self.CheckDarkMode.clicked.connect(self.checkStyle)
        self.CheckEffect.clicked.connect(self.checkStyle)
        self.CheckPDF.clicked.connect(self.checkPDF)

    def retranslateUi(self, settings):
        _translate = QtCore.QCoreApplication.translate
        settings.setWindowTitle(_translate("settings", "Settings"))
        self.label.setText(_translate("settings", "تنظیمات"))
        self.ButtBack.setWhatsThis(
            _translate(
                "settings",
                "<html><head/><body><p align=\"center\">برگشت</p></body></html>"
            ))
        self.label_2.setText(_translate("settings", Version))
        self.CheckPDF.setText(
            _translate("settings", "نمایش داده شود PDF بعد از دریافت خروجی"))
        self.CheckDarkMode.setText(
            _translate("settings", "حالت تیره - Dark Mode"))
        self.CheckBilan6Month.setText(
            _translate("settings", "بیلان 6 ماه نخست"))
        self.CheckChangeBy1000.setText(
            _translate("settings", "اعداد 1000 تایی تغییر کند"))
    ...
    def checkBilan(self):
        ...
        if bool(obj.isCheckable()):
            ...
            saveJson()
        try:
            Page.bilan.comboBoxUpdate(Type='month')
        except:
            pass
...
class Ui_bilan(object):
    ...
    def setupUi(self, bilan):
        ...
        self.spinBoxManba.setCursor(QtGui.QCursor(
            QtCore.Qt.PointingHandCursor))
        ...
        self.spinBoxKharj.setCursor(QtGui.QCursor(
            QtCore.Qt.PointingHandCursor))
        ...
        self.name = bilan
        self.checkStyle()
        self.comboBoxUpdate(Everything=True)
    ...
    def retranslateUi(self, bilan):
        ...
        self.ButtBack.setWhatsThis(
            _translate(
                "bilan",
                "<html><head/><body><p align=\"center\">بازگشت</p></body></html>"
            ))
    ...
    def comboBoxUpdate(self, Type='', Everything=False):
        global Data, Data_2
        self.checkStyle()
...
class Ui_ab(object):
    ...
    def setupUi(self, ab):
        ...
        self.spinBoxNafar.setCursor(QtGui.QCursor(
            QtCore.Qt.PointingHandCursor))
        ...
        self.spinBoxVahed.setCursor(QtGui.QCursor(
            QtCore.Qt.PointingHandCursor))
        ...
        self.name = ab
        shadowEffect(self.name,
                     QtWidgets.QPushButton,
                     'light',
                     Filter=['ButtPlus100', 'ButtMine100'],
                     onlyFilter=True)
        self.checkStyle()
        ...
        self.spinBoxVahed.valueChanged.connect(
            lambda: self.spinBoxNafar.setValue(Data['Nafarat'][str(
                self.spinBoxVahed.value())]))
        ...
        if not Data['DarkMode']:
            ...
            if Data['ShadowEffect']:
                shadowEffect(self.name,
                             ...
                             'light',
                             Filter=[
                                 'ButtPlus100', 'ButtMine100', 'ButtSettings',
                                 'ButtBack'
                             ])
                self.label.setGraphicsEffect(
                    Qt.QGraphicsDropShadowEffect(
        ...
        if button:
            ...
            if sign == '+':
                self.lcdNumberSahmRound.setProperty(
                    "intValue",
                    int(self.lcdNumberSahmRound.value()) + value)
            if sign == '-':
                self.lcdNumberSahmRound.setProperty(
                    "intValue",
                    int(self.lcdNumberSahmRound.value()) - value)
...
class Ui_sharj(object):
    ...
    def setupUi(self, sharj):
        ...
        self.spinBoxSharj.setCursor(QtGui.QCursor(
            QtCore.Qt.PointingHandCursor))
        ...
        self.lineEditMolahezat.setLocale(
    ...
    def updateData(self, key=''):
        ...
        if key == 'sharj':
            ...
            hazine = [
                Data['Nafarat'][val] * sahmNafarRound, Data['Bedehi'][val],
                self.spinBoxMolahezat.value(),
                self.spinBoxSharj.value(),
                self.spinBoxOmrani.value()
            ]
            self.spinBoxBedehi.setValue(hazine[1])
            self.lcdNumberHazineAb.setProperty("intValue", hazine[0])
            self.lcdNumberMablagh.setProperty("intValue",
                                              int(sum(hazine)) + int(val))
...
class Ui_abyari(object):
    ...
    def setupUi(self, abyari):
        ...
        self.lineEditTarikh1.setLocale(
            QtCore.QLocale(QtCore.QLocale.Persian, QtCore.QLocale.Iran))
        ...
        self.lineEditTarikh2.setLocale(
            QtCore.QLocale(QtCore.QLocale.Persian, QtCore.QLocale.Iran))
...
class Ui_output(object):
    ...
    def setupUi(self, output):
        ...
        self.CheckAbyari.setCursor(
            QtGui.QCursor(
                setCurser(Data_3['donePages']['abyari']
                          or Data['PDF_outputUnDone'])))
        ...
        self.name = output
        self.temp = [
            self.CheckBilan6Month.checkState(),
            self.CheckSharj.checkState(),
            self.CheckAb.checkState(),
            self.CheckAbyari.checkState()
        ]
        self.checkStyle()
    ...
    def retranslateUi(self, output):
        ...
        self.CheckBilan6Month.setText(_translate("output",
                                                 "صفحه بیلان 6 ماهه"))
    ...
    def done(self):
        ...
        if any(self.temp):
            ...
            self.ButtSabt.setCursor(QtGui.QCursor(
                QtCore.Qt.PointingHandCursor))
        else:
            sendNotification(
